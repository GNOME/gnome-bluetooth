			       ...
			       GParamSpec     *pspec)
{
	...
	case PROP_DEFAULT_ADAPTER_DISCOVERABLE:
		...
		discovering = _bluetooth_client_get_default_adapter_discovering (self);
		_bluetooth_client_set_default_adapter_discovering (self, discovering, priv->disco_during_disco);
		break;
	case PROP_DEFAULT_ADAPTER_DISCOVERING:
